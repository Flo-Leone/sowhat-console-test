...
const candidateData = {
  ...
  comments: [
    ...
    { id: "2", text: "Entretien très positif", author: "Admin SW.AI", date: "01/18/26, 4:00 PM" },
  ],
  history: [
    { date: "Jan 19, 2026", action: "Statut changé en Recruté par", user: "Stephane Boussely", type: "internal" as const },
    { date: "Nov 05, 2025", action: "Entretien réalisé", user: "", type: "candidate" as const },
    { date: "Oct 30, 2025", action: "Appel téléphonique", user: "", type: "candidate" as const },
